...
I'm a software engineering student with a background in algorithms, systems, and data analysis — now expanding into full-stack web development. I enjoy turning complex problems into clean, working software.

- Currently learning: **React · Node.js · Flask**
- Strong background in: **C++ · Python · SQL · Data Analysis**
- Available for freelance: web apps, scripts, data projects
...
| Service | Description |
|---|---|
| 🌐 Web Development | Landing pages, portfolios, full-stack web apps |
| 🐍 Python Scripting | Automation, web scraping, data processing |
| 📊 Data Analysis | Cleaning, visualization, reporting (Python/R/SQL) |
| 🗄️ Database Design | Schema design, queries, PostgreSQL |

> Interested in working together? → **[matias_mjcm@hotmail.com](mailto:matias_mjcm@hotmail.com)**
